                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="ubah_artikel.php">Ubah Artikel</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="form_artikel.php">Buat Artikel</a>
                              </li>
                              <li class="nav-item login">
                                 <a class="nav-link login" href="index.php">logout</a>
                              </li>
                           </ul>
                        </div>
                     </nav>
